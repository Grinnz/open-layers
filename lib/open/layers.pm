...
recommended to use a recent Perl and a Linux-like architecture if you will be
using complex layers. Here are some selected issues:

=item *

Before Perl 5.8.8, L<open()|perlfunc/open> did not know about
L<${^OPEN}|perlvar/${^OPEN}> and thus ignored any lexical default layers.
